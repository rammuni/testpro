        ...
        <div class="register">
            <div class="container">
                <div class="register-top heading">
                    <h2>Login to WATCHES-LK</h2>
                </div>
                <div class="register-main">
                    <div class="col-sm-3 account-left"></div>
                    <div class="col-sm-6 account-left">
                        ...
                        <div class="form-check">
                            <input type="checkbox" value="ok" class="form-check-input" id="logbtn">
                            <label class="form-check-label" for="exampleCheck1">Remember Me</label>
                        </div>
                        <div class="address submit">
                            <input type="button" value="Login" onclick="SignInUser()">
                        </div>
                    </div>
                    <div class="col-sm-3 account-left"></div>
                    <!--<div class="clearfix"></div>-->
